...
author: "Miguel Lucas, Marcelo De Rada Ocampo, Prathamesh Dhole, Harshul LilANI, Ollie Phillpott"
output:
  html_document:
...
# The Data
(Data source: https://www.kaggle.com/c/house-prices-advanced-regression-techniques/data. We acknowledge Dean De Cock for compiling the Ames Housing dataset we are using.)

Ask a home buyer to describe their dream house, and they probably won't begin with the height of the basement ceiling or the proximity to an east-west railroad. We plan to use this competition's dataset to find hidden factors that influence price negotiations, beyond simply the number of bedrooms. We plan to use this insight to decide what to buy and what to build in the two contexts described above.
...
The following steps are the start point for the outline of our analysis. These are subject to change.
