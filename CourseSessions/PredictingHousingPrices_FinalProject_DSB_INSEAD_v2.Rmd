# To-Do's
# 1) Separate Training data (80/20)
...
# Lasso - good start and try different values for penalisation parameter Beta. Vary the parameter and see which variables get dropped - these may be a candidate for dropping.
# Linear regression
# Log data linear regression
...
training.x <-model.matrix(SalePrice~ ., data = train_new)
testing.x <-model.matrix(SalePrice~ ., data = train_new)
